...
using VI = vector<int>;
// =====================================================================
// Z_OI_I128: __int128 IO
// 依赖顺序: 本块需在 Z_OI_MODLL 之前装配 (后者使用 i128)
// =====================================================================
#ifndef Z_OI_I128
#define Z_OI_I128
...
// =====================================================================
// Z_OI_MODLL: 编译期自动路由的取模整数类
//   逆元:    质数 -> 费马小定理 / 非质数 -> exgcd
//   乘法:    MOD^2 不溢出 LL -> 直乘 / 否则 -> i128
//   组合数:  质数 -> 阶乘表 O(1) / 非质数 -> spf 筛 + 指数追踪
//   i128:   构造 / 读入 / 幂指数 全面支持 128 位
// =====================================================================
#ifndef Z_OI_MODLL
#define Z_OI_MODLL
...
public:
    ...
    {
        i128 v; is >> v;                  // 借道 i128 解析: 39 位大数读入即自动取模
        o = ModLL(v);
        return is;
    }
