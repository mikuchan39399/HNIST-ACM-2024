...
先看 **[库里有什么](features/README.md)**：算法范围、笔记边界和辅助工具；具体模板从 [算法目录](features/catalog.md) 点进源码。
...
本地 ZIP 放 docs/releases/，私人恢复备份放 docs/backups/；这些产物不提交，也不进入队友包，目录里的 README 指南仍随包交付。
