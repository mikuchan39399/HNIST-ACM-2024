...
foreach ($file in @('run_checks.ps1', 'check_process.ps1', 'check_inventory.ps1', 'check_verification.ps1')) { Copy-Item -LiteralPath (Join-Path $PSScriptRoot $file) -Destination (Join-Path $fixture 'scripts') }
